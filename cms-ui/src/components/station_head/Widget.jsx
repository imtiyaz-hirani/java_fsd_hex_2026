                ...
                <div className="row row-cols-1 row-cols-md-3 g-3 w-100 mx-auto mb-4">
                    ...
                    <div className="col-12 col-md-4"  >
                        <div className="metric-card p-3 bg-white border border-light shadow-sm rounded-3 d-flex align-items-center gap-3">
                            ...
                            <div>
                                <h3 className="text-muted fs-7 text-uppercase tracking-wider mb-0 fw-semibold">Officers</h3>
                                <p className="fs-3 fw-bold text-dark mb-0 leading-none">34</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-12 col-md-4"  >
                        <div className="metric-card p-3 bg-white border border-light shadow-sm rounded-3 d-flex align-items-center gap-3">
                            ...
                            <div>
                                <h3 className="text-muted fs-7 text-uppercase tracking-wider mb-0 fw-semibold">Incidents</h3>
                                <p className="fs-3 fw-bold text-dark mb-0 leading-none">245</p>
                            </div>
                        </div>
                    </div>
                    {/* <!-- Station Metric Card --> */}
                    <div className="col-12 col-md-4"  >
                        <div className="metric-card p-3 bg-white border border-light shadow-sm rounded-3 d-flex align-items-center gap-3">
                            ...
                            <div>
                                <h3 className="text-muted fs-7 text-uppercase tracking-wider mb-0 fw-semibold">Station</h3>
                                <p className="fs-3 fw-bold text-dark mb-0 leading-none">8</p>
                            </div>
                        </div>
                    </div>
                </div>
